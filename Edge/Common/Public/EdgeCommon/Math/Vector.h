...
namespace Edge
{
	...
	struct Vector3Base final
	{
		...
		constexpr Vector3Base(const Vector2Base<ValueType>& vector, ValueType z) : m_x(vector.m_x), m_y(vector.m_y), m_z(z) {}
	...
	struct Vector4Base final
	{
		...
		constexpr Vector4Base(const Vector2Base<ValueType>& vector1, const Vector2Base<ValueType>& vector2) : m_x(vector1.m_x), m_y(vector1.m_y), m_z(vector2.m_x), m_w(vector2.m_y) {}
		constexpr Vector4Base(const Vector2Base<ValueType>& vector, float z, float w) : m_x(vector.m_x), m_y(vector.m_y), m_z(z), m_w(w) {}
		constexpr Vector4Base(const Vector3Base<ValueType>& vector) : m_x(vector.m_x), m_y(vector.m_y), m_z(vector.m_z), m_w(DefaultValue) {}
		constexpr Vector4Base(const Vector3Base<ValueType>& vector, float w) : m_x(vector.m_x), m_y(vector.m_y), m_z(vector.m_z), m_w(w) {}
