...
void Edge::RenderController::prepareData(const Renderer::CameraTransforms& cameraTransforms, const DebugVisualizationDataController& visualizationData)
{
	assert(m_renderer);
	m_renderer->prepareData(cameraTransforms, visualizationData);
}
