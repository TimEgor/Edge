...
void EdgeD3D11::D3D11DeferredGraphicContext::setConstantBuffer(const Edge::GPUBuffer& buffer, uint32_t slot, Edge::GraphicContextBindingShaderStage shaderStages)
{
...
void EdgeD3D11::D3D11DeferredGraphicContext::mapBuffer(Edge::GPUBuffer& buffer, Edge::GraphicResourceMappingType type, Edge::GraphicResourceMappingFlag flag, void** data)
{
	D3D11GPUBuffer& d3d11Buffer = static_cast<D3D11GPUBuffer&>(buffer);
