...
#include "TinySimCommon/Core/Memory.h"

TS_D3D11::D3D11GPUBuffer::D3D11GPUBuffer(const TS::GPUBufferDesc& desc, const D3D11DeviceComPtr& device, const TS::InitialGPUBufferData* initialData)
	: GPUBuffer(desc)
{
	D3D11_BUFFER_DESC d3d11Desc{};
	d3d11Desc.ByteWidth = TS::align(desc.m_size, 16u);
