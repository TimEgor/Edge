...
#define EDGE_DYNAMIC_LIB_EXT_NAME TS_TO_STRING_DEF(EDGE_DYNAMIC_LIB_EXT)
#define EDGE_DYNAMIC_LIB_FULL_EXT_NAME TS_TO_STRING_DEF(.EDGE_DYNAMIC_LIB_EXT)

#define EDGE_PLATFORM_NAME TS_TO_STRING_DEF(EDGE_PLATFORM)