...
size_t Edge::StringSubstitutionProcessor::processSubstring(size_t beginPos, size_t endPos)
{
...
void Edge::StringSubstitutionProcessor::replaceSubstring(size_t beginPos, size_t endPos)
{
	if (beginPos >= endPos)
	{
		return;
...
Edge::StringSubstitutionProcessor::ResultStringType Edge::StringSubstitutionProcessor::process()
{
